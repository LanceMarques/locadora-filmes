...
public class LocadoraExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/**
	 * Metodo que trata a excecao lancada quando o cliente envia uma requisicao contendo um body malformatado
	 * 
	 ...
	 * @return resposta para o cliente, informando o status BAD_REQUEST, alem da mensagem para o desenvolvedor do
	 * front-end (informacoes pertinentes sobre o erro ocorrido), bem como mensagem para o usuario (validacao dos
	 * campos, mensagem alto nivel)
	 */
	@Override
	...
	/**
	 * Metodo que trata a excecao lancada quando o cliente envia uma requisicao contendo campos obrigatorios vazios ou
	 * com tamanho minimo/maximo fora do permitido
	 * 
	...
	/**
	 * Metodo que trata a excecao lancada quando o cliente envia uma requisicao que viola as integridades dos dados no
	 * banco de dados. Ex: Unique keys
	 * 
	...
	/**
	 * Metodo que cria uma lista de erros. Usado quando ha mais que uma mensagem de erro a ser mostrada ao usuario e ao
	 * desenvolvedor.
	 * 
