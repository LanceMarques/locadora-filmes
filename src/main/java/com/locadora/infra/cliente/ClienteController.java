...
/**
 * Classe responsavel por mapear as requisições realizadas nas URIs da entidade Cliente
 * 
...
public class ClienteController {
  ...
  /**
   * Metodo responsavel por fornecer uma lista com todos os {@link Cliente clientes} cadastrados.
   * 
   * @return {@link ResponseEntity} com todos os {@link Cliente clientes} cadastrados.
   * 
   * @since 1.0.0
   */
  @GetMapping
   ...
   * @return {@link ResponseEntity} com o cliente{@link Cliente} cadastrado no sistema.
   * 
   * @since 1.0.0
   */
  @PostMapping
  ...
  /**
   * Metodo responsavel por atualizar um {@link Cliente cliente} que possui o id recebido no path
