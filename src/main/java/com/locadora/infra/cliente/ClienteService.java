...
public class ClienteService {
  ...
  /**
   * Metodo responsavel por fornecer uma lista com todos os {@link Cliente clientes} cadastrados no
   * sistema
   * 
   * @return Lista com todos os {@link Cliente clientes} cadastrados
   */
  ...
  /**
   * Metodo responsavel por fornecer um {@link Cliente cliente} que possui o id informado.
   * 
   * @param id ({@link Integer}) Id requisitado na pesquisa
   * @return cliente{@link Cliente}} que possui o id informado.
   * 
   * @since 1.0.0
   */
  ...
  /**
   * Metodo responsavel por fornecer um {@link Cliente cliente} que possui o cpf informado.
   * 
   * @param cpf ({@link String}) CPF requisitado na pesquisa
   * @return cliente{@link Cliente}} que possui o cpf informado.
   * 
   * @since 1.0.0
   */
  ...
  /**
   * Metodo responsavel por fornecer um {@link Cliente cliente} que possui o cpf informado. Lanca
   * uma excecao caso o cliente nao for encontrado
   * 
   * @param cpf ({@link String}) CPF requisitado na pesquisa
   * @return cliente{@link Cliente}} que possui o cpf informado.
   * 
   ...
   * 
   * @param cliente({@link Cliente}) cliente recebido como parametro para cadastro no sistema
   * @return Cliente{@link cliente} cadastrado no sistema.
   * 
   * @since 1.0.0
   */
  ...
  /**
   * Metodo responsavel por atualizar um {@link Cliente cliente} que possui o id solicitado com os
  ...
  /**
   * Metodo responsavel por excluir um {@link Cliente cliente} que possui o id informado.
   * 
