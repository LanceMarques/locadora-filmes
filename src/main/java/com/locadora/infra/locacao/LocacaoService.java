...
public class LocacaoService {
   ...
   * sistema que se adequam ao filtro recebido como parametro.
   * 
   * @param {@link LocacaoFilter} Filtro aplicado na consulta de locacoes
  ...
  /**
   * Metodo responsavel por fornecer uma lista com todas as {@link Locacao locacoes} em aberto do
   * cliente que possui o cpf recebido como parametro.
   * 
  ...
  /**
   * Metodo responsavel por fornecer uma lista com todas os {@link LocacaoTemFilme filmes} de uma
   * locacao que possua o id recebido como parametro.
   * 
   * @param id{@link Integer} Id da locacao requisitado na pesquisa.
   * @return {@link LocacaoTemFilme filmes} Lista com todos os filmes de uma locacao. pesquisa.
   */
   ...
   * 
   * @param locacao({@link Locacao}) locacao recebido como parametro para cadastro no sistema
  ...
  /**
   * Metodo responsavel por atualizar uma {@link Locacao locacao} que possui o id solicitado com os
   * dados recebidos no corpo da requisicao.
   * 
  ...
  /**
   * Metodo responsavel por efetivar o processo de devolucao de uma {@link Locacao locacao} que
   * possui o id recebido como parametro.
   * 
  ...
  /**
   * Metodo responsavel por validar e inicializar os dados da locacao a ser cadastrada.
   * 
  ...
  /**
   * Metodo responsavel por atualizar o estoque dos filmes de uma locacao devolvida recebida como
   * parametro
   * 
  ...
  /**
   * Metodo responsavel por fornecer uma lista que tenha apenas as {@link Locacao locacoes} em
   * aberto do cliente que possui o cpf recebido como parametro
   * 
   * @param cpf {@link String} Cpf requisitado na pesquisa
   * @return locacoes {@link Locacao} Lista com todas as {@link Locacao locacoes} encontradas na
   *         pesquisa
